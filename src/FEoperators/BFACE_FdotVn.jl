struct BFACE_FdotVn <: FiniteElements.AbstractFEOperator end

function assemble_operator!(b, ::Type{BFACE_FdotVn}, FE::AbstractH1FiniteElement, Dbid::Int64, f!::Function, quadorder_f::Int)
            ...
            for i in eachindex(qf.w)
                ...
                for dof_i = 1 :FEbasis.ndofs4item
                    ...
                    @inbounds begin
                        ...
                        b[FEbasis.current_dofs[dof_i]] += fval[1] * temp * qf.w[i] * FE.grid.length4faces[face];
                    end
                end
            end
        end    
...
function assemble_operator!(b, ::Type{BFACE_FdotVn}, FE::AbstractHdivFiniteElement, Dbid::Int64, f!::Function, quadorder_f::Int)
    ensure_bfaces!(FE.grid);
    ensure_length4faces!(FE.grid);
    ...
    FEbasis = FiniteElements.FEbasis_caller_face(FE, qf);
    basisvals = zeros(Float64,FEbasis.ndofs4item,FEbasis.ncomponents)
    dofs = zeros(Int64,FEbasis.ndofs4item)
