struct CELL_L2_FplusA <: FiniteElements.AbstractFEOperator end

function assemble_operator!(b, ::Type{CELL_L2_FplusA}, f!::Function, FE::AbstractFiniteElement, val4dofsA; degreeF::Int = 2, factorA::Real = 1.0)
