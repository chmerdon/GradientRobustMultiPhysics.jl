...
function TestInterpolation2D(fem::String, order::Int, ncomponents::Int = 1, on_squares::Bool = false)
    ...
    if on_squares
        grid = gridgen_unitsquare_squares(0.1)
    else
...
function TestBestApproximation2D(norm::String, fem::String, order::Int, on_squares::Bool = false)
