...
# BASIS FUNCTIONS
function get_basis_on_elemtype(FE::HdivRT1FiniteElement, ::Grid.ElemType2DTriangle)
    temp = 0.0;
    a = [0.0 0.0];
    b = [0.0 0.0];
    c = [0.0 0.0];
...
function get_basis_fluxes_on_elemtype(FE::HdivRT1FiniteElement, ::Grid.Abstract1DElemType)
    function closure(xref)
