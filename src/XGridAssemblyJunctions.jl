...
abstract type AbstractAssemblyTypeBFACECELLDOFS <: AbstractAssemblyType end # celldofs on bfaces
...
GridComponentNodes4AssemblyType(::Type{AbstractAssemblyTypeBFACECELLDOFS}) = BFaceNodes
...
xrefFACE2xrefCELL(::Type{<:Triangle2D}) = [ (xref4FACE) -> [xref4FACE,0],
                                            (xref4FACE) -> [1-xref4FACE,xref4FACE], 
                                            (xref4FACE) -> [0,1-xref4FACE] ]

xrefFACE2xrefCELL(::Type{<:Parallelogram2D}) = [ (xref4FACE) -> [xref4FACE,0],
                                                 (xref4FACE) -> [1,xref4FACE], 
