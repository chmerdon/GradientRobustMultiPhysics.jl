abstract type Abstract2DQuadrilateral <: Abstract2DElemType end

# they better should be convex at least ?!


function get_reference_cordinates(::Abstract2DQuadrilateral)
    return [0 0;
            1 0;
            1 1;
            0 1]
...
function get_face_elemtype(::Abstract2DQuadrilateral)
    return ElemType1DInterval();
end


# perform a barycentric refinement of 2D parallelograms
function uniform_refinement(::Abstract2DQuadrilateral,coords4nodes::Array,nodes4cells::Array,nodes4bfaces::Array = [[] []],bregions::Array = [])
...
# perform a barycentric refinement of 2D parallelograms
function divide_into_triangles(::Abstract2DQuadrilateral,nodes4cells::Array)
...
function local2global_face(grid::Mesh, ::Abstract2DQuadrilateral)
