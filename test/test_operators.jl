...
function test_2nd_derivs()
    ...
    L = zeros(Float64,2)
    GradientRobustMultiPhysics.eval!(L, FEBE_L, Iu.entries[FES[CellDofs][:,1]], 1)
    GradientRobustMultiPhysics.eval!(H, FEBE_H, Iu.entries[FES[CellDofs][:,1]], 1)
    GradientRobustMultiPhysics.eval!(symH, FEBE_symH, Iu.entries[FES[CellDofs][:,1]], 1)
    GradientRobustMultiPhysics.eval!(symH2, FEBE_symH2, Iu.entries[FES[CellDofs][:,1]], 1)
